-- Host: localhost    Database: flujo_presupuesto_presupuesto
-- ------------------------------------------------------
-- Server version	5.5.24-5

-- install the database after db creation
-- set level and user privileges
grant usage on flujo_presupuesto.* to flujo_presupuesto@localhost identified by '@flujo_presupuesto#';
grant select, insert, update, delete, drop, alter, create temporary tables on flujo_presupuesto.* to flujo_presupuesto@localhost;
flush privileges;
