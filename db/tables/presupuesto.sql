...
--
-- Host: localhost
-- Generation Time: Nov 05, 2014 at 06:15 PM
...
CREATE TABLE IF NOT EXISTS `presupuesto` (
  ...
  `id_flota` int(11) unsigned DEFAULT NULL,
  `area` varchar(255) DEFAULT NULL,
  `unidadNegocio` varchar(255) DEFAULT NULL,
  `presupuesto` decimal(18,6) DEFAULT NULL,
  `year` year(4) DEFAULT NULL,
  `month` int(3) DEFAULT NULL,
  `week` int(3) DEFAULT NULL,
  `fdatetime` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
