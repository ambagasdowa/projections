 ...
 */
	Configure::write('Security.cipherSeed', '76859309657453542496740683645');
...
//   APC (http://pecl.php.net/package/APC)
 /** NOTE @ambagasdowa if somwthing goes wrong  comment this and uncomment the next line with engine file */
  	 Cache::config('default', array(
 		'engine' => 'Apc', //[required]
 		'duration'=> 3600, //[optional]
 		'probability'=> 100, //[optional]
