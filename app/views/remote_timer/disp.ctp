...
//     $time = $chronos[$key]['ServiciosProgramados']['hora'];
	$time = date('H:i:s'); // temporal fix _ remove this
...
//     window.webkitNotifications.createHTMLNotification(url);
    window.webkitNotifications.createNotification("<?php e($this->webroot."img/icons/alarm-clock_22.png");?>", "Ramos Arizpe", "Generar Reporte <?php
    e(" Reporte Generado ");
    ?>").show();
