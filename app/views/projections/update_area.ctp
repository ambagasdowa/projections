...
<!-- 			    <td /> -->
<!-- 			  <tr /> -->
<!-- 			    <td />Toneladas para el mes en curso -->
			  <tr />
...
// 			);
		...
		<td colspan="2" style="text-align:center;" />
		    <?php 
		      $today = date('Y-m-d');
		      echo $this->Html->link( 
			   $this->Html->image("thumbs/daily/toneladas_".$AreaCorp['Area']."_".$numMonth."_".$_SESSION['Auth']['User']['year'].".png", 
			                array("alt" => "Detalles",
					      'title' => 'Detalles',
				              'width' => '680',
				              'height' => '210'
...
// 		  e($flt[$key][0]);
		  echo $this->Html->link(detalles,
					...
					array(
					    'class'=>'button_link btn btn-default',
   ...
   <table id="<?php e(idTotalIndex);?>" class="table table-responsive">
	  <td style="text-align:center;font-size:12px;font-variant:small-caps;"/>
		  <a href="#" class="btn btn-default" role="button" onclick="Effect.toggle('detallesFlotasToneladas', 'appear'); return false;">
			&#9660; Flotas &#9660;
		  </a>
  </table>
  <div id="detallesFlotasToneladas" style="display:none;">
	    <?php $idx=1;?>
