...
<!--   <div id="waiting" style="display:none;">Recalculating Projeccion</div> -->
	...
	<div id="divDisponibilidad<?php e(ucfirst($fleetConfig));?>" <?php e($style)?> >
      ...
      <table id="menu_info_small">
		<tr />
		<td colspan="5" style="text-align:center;font-size:20px;" />Con datos al <?php e($disponibilidad['disponibilidad']['date']['day']);?> de <?php e($disponibilidad['disponibilidad']['date']['mes']);?> de <?php e($disponibilidad['disponibilidad']['date']['year']);?>
	    <tr />
...
// 					e(number_format(round($disponibilidad['projectado']['totalGlobalVarPromedioDiario'])).' %');
				  ?>
			  <tr />
			    <td style="text-align:center;font-size:<?php e($_SESSION['projections']['viewConfig']['fontSizeTitle']);?>%;" />Observaciones
			  <tr />
...
// 					e(number_format(money_format('%i',$disponibilidad['projectado']['totalGlobalProjectionOperationData']), 2, '.', ','));
				  ...
				  ?>
			  <tr />
			    <td style="text-align:center;font-size:<?php e($_SESSION['projections']['viewConfig']['fontSizeTitle']);?>%;" />Otros Fletes
			  <tr />
<!-- 			    <td style="text-align:center;" /> -->
			</table>
	  </table>
