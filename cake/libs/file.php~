...
// 		http://stackoverflow.com/questions/2941574/error-appearing-in-application-after-updating-cakephp-library-files-from-1-3-0-t
		$data = trim($data); // NOTE unserialized error patch from stackoverflow
		if ($this->lock !== null) {
